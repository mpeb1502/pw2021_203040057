...
<body class="red">
  ...
  <form action="" method="post">
    <div class="card-panel z-depth-5">
      ...
      <div class="center">
        <input type="submit" value="REGISTER" name="register" class="btn waves-effect red " style="width:100%; background-color: #36a5b2;">
        <br>
        <br>
        <div class="center">
          <a href="login.php" class="btn waves-effect red " style=width:100%; background-color: #36a5b2;"">Kembali</a>
        </div>
      </div>
