...
--
-- Database: `pw_tubes_203040057`
--

-- --------------------------------------------------------

--
-- Table structure for table `manchester_united`
--

CREATE TABLE `manchester_united` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `manchester_united`
--

INSERT INTO `manchester_united` (`id`, `nama_pemain`, `deskripsi`, `lahir`, `berat_badan`, `tinggi_badan`, `foto`) VALUES
...
--
-- Indexes for table `manchester_united`
--
ALTER TABLE `manchester_united`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `manchester_united`
--
ALTER TABLE `manchester_united`
