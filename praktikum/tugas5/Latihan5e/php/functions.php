...
<?php 
    ...
    {
    $conn = koneksi();
    mysqli_query($conn, "DELETE FROM manchester_united  WHERE id = $id");
    ...
    $conn = koneksi();
    $id = ($data['id']);
    $nama_pemian = htmlspecialchars($data['nama_pemain']);
    $deskripsi = htmlspecialchars($data['deskripsi']);
    $lahir = htmlspecialchars($data['lahir']);
    $berat_badan = htmlspecialchars($data['berat_badan']);
    $tinggi_badan = htmlspecialchars($data['tinggi_badan']);
    ...
    $query = "UPDATE manchester_united SET
    nama_pemain = '$nama_pemian',
    deskripsi = '$deskripsi',
    lahir = '$lahir',
    ...
    if (isset($_GET['cari'])) {
        ...
        $manchesterunited = query("SELECT * FROM manchester_united WHERE
                             nama_pemain LIKE '%$keyword%' OR
                             deskripsi LIKE '%$keyword%' OR
                             lahir LIKE '%$keyword%' OR
                             berat_badan LIKE '%$keyword%' OR
                             berat_badan LIKE '%$keyword%' ");
    } else {
