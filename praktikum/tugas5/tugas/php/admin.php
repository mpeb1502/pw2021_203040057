...
// jika tombol di klik
if (isset($_GET["cari"]) ) {
    $manchesterunited = cari($_GET["keyword"]);
}
    ...
    <table border="1" cellpadding="13" cellspacing="0">
        ...
        <?php foreach ($manchesterunited as $mu) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <div><a href="ubah.php?id="<?= $mu['id'] ?>><button>Ubah</button></a></div>
                    <div><a href="hapus.php?id=<?= $mu['id']; ?>" onclick="return confirm('Hapus Data??')">Hapus</a></div>
                </td>
